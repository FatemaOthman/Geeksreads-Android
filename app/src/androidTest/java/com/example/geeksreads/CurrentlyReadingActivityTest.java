...
public class CurrentlyReadingActivityTest {

    UserSessionManager userSessionManager = new UserSessionManager("xYzAbCdToKeN","anyid",true);

    @Rule
    public ActivityTestRule<CurrentlyReadingActivity> menuActivityTestRule =
            new ActivityTestRule<>(CurrentlyReadingActivity.class, true, true);
