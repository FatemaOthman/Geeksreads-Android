...
public class WantToReadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String UrlService = APIs.API_GET_WANTTOREAD_LIST;
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                GetWanttoReadBooks performBackgroundTask = new GetWanttoReadBooks();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                Intent intent = new Intent(WantToReadActivity.this,SearchHandlerActivity.class);
                intent.putExtra("CallingActivity","WantToReadActivity");
        ...
        item1.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent mIntent = new Intent(WantToReadActivity.this, NotificationActivity.class);
